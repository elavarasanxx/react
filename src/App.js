...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Createx onEmployeeCreate = {handleEmployeeCreate}/>
      <Readx employees={employees} onEmployeeSelect={setSelectedEmployee}/>
      <Update employee={selectedEmployee} onUpdate={handleUpdate}/>
    </div>
  );
}
